...
Girişimsel radyoloji konularındaki bilginizi aşağıdaki kapsamlı quiz ile test edebilirsiniz. Quiz, bu rehberde ele alınan tüm konuları kapsamaktadır:

- Temel malzeme bilgisi (French, Gauge, kılavuz teller)
- Seldinger tekniği ve vasküler erişim
- DSA, PTA ve stentleme prosedürleri
- Embolizasyon teknikleri ve ajanları
- Biyopsi, drenaj ve ablasyon işlemleri
- Santral venöz kateter ve port yerleştirme
- Komplikasyon yönetimi ve güvenlik önlemleri

<QuizComponent client:load quizFile="interventional-radiology-quiz.json" />
